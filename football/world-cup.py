...
def split_matches(fixtures_blob, n):  # split fixtures list into individual matches by splitting into list of elements of n strings
    # I expect n to be 3
    if n < 1:
        n = 1
...
def process_results(results) -> object: # using this to see if I can add goals up. so far only works on first result
    total_goals = 0
